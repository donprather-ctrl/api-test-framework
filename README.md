...
- Sort inventory by price low to high with sort order assertion
- Remove item from cart with empty cart assertion
- Navigate to cart page and back to inventory with cart count preserved
